...
> **Status:** Shipped as separate repo  
> **Type:** Feature / product split  
> **Implementation:** https://github.com/mosesman831/polygnosis-api
...
Ship **PolyGnosis API** as its own repository — not a lite claim-verify endpoint, and not a Hermes skill wrap.
...
| | This repo (Hermes skill) | [polygnosis-api](https://github.com/mosesman831/polygnosis-api) |
|--|--------------------------|------------------------------------------------------------------|
...
- Separate public repo with installable FastAPI service
